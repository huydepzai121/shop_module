...
if ($number > 0) {
    $siteinfo[] = array(
        'key' => $nv_Lang->getModule('product_number_all'),
        'value' => $number
    );
}
...
if ($number > 0) {
    $pendinginfo[] = array( 'key' => $nv_Lang->getModule('siteinfo_pending'), 'value' => $number );
}
...
if ($number > 0) {
    $pendinginfo[] = array( 'key' => $nv_Lang->getModule('siteinfo_exptime'), 'value' => $number );
}
...
if ($number > 0) {
    $pendinginfo[] = array( 'key' => $nv_Lang->getModule('siteinfo_comment_pending'), 'value' => $number );
}
...
if ($number > 0) {
    $siteinfo[] = array(
        'key' => $nv_Lang->getModule('product_number_order'),
        'value' => $number
    );
}
...
if ($number > 0) {
    $pendinginfo[] = array( 'key' => $nv_Lang->getModule('siteinfo_order_noview'), 'value' => $number );
}
...
if ($number > 0) {
    $pendinginfo[] = array(
        'key' => $nv_Lang->getModule('review_pending'),
        'value' => $number,
