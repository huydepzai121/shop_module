...
foreach ($listid as $id) {
    ...
    $xtpl->assign('product_price', number_format($product_price, nv_get_decimals($pro_config['money_unit'])));
...
$xtpl->assign('order_total', number_format($data['order_total'], nv_get_decimals($pro_config['money_unit'])));
$xtpl->assign('unit', $data['unit_total']);

$payment = ($data['order_total'] == '1') ? $nv_Lang->getModule('order_payment') : $nv_Lang->getModule('order_no_payment');
