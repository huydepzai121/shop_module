...
$array_cat_search[0] = array(
    'catid' => 0,
    'title' => $nv_Lang->getModule('search_all'),
...
$page_title =  $nv_Lang->getModule('search_title') . NV_TITLEBAR_DEFIS . $module_info['site_title'];

$key_words = $module_info['keywords'];
$mod_title = $nv_Lang->getModule('main_title');
