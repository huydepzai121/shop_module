...
$total = number_format($total, nv_get_decimals($pro_config['money_unit']));

$lang_tmp['cart_title'] = $nv_Lang->getModule('cart_title');
$lang_tmp['cart_product_title'] = $nv_Lang->getModule('cart_product_title');
$lang_tmp['cart_product_total'] = $nv_Lang->getModule('cart_product_total');
$lang_tmp['cart_check_out'] = $nv_Lang->getModule('cart_check_out');
$lang_tmp['history_title'] = $nv_Lang->getModule('history_title');
$lang_tmp['active_order_dis'] = $nv_Lang->getModule('active_order_dis');
$lang_tmp['wishlist_product'] = $nv_Lang->getModule('wishlist_product');
$lang_tmp['point_cart_text'] = $nv_Lang->getModule('point_cart_text');
$lang_tmp['title_products'] = $nv_Lang->getModule('title_products');
$lang_tmp['cart_check_cart'] = $nv_Lang->getModule('cart_check_cart');
