...
$array_displays = [
    '0' => $nv_Lang->getModule('displays_new'),
    '1' => $nv_Lang->getModule('displays_price_asc'),
    '2' => $nv_Lang->getModule('displays_price_desc')
];
...
{
    global $module_data, $module_info, $module_upload, $module_file, $db_config, $db, $global_config, $nv_Lang;
