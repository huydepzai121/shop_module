...
if (in_array($lang, $array_lang_module_setup) and $num_table > 1) {
    ...
    $sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_products_price';
    $sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_price_config';
    $sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_price_history';
    $set_lang_data = '';
}
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_discounts (
  ...
  cateid varchar(250) NOT NULL DEFAULT '' COMMENT 'Danh sách danh mục áp dụng',
  PRIMARY KEY (did),
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_guarantee (
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  warranty_code varchar(50) NOT NULL DEFAULT '',
  purchase_date int(11) unsigned NOT NULL DEFAULT '0',
  warranty_start int(11) unsigned NOT NULL DEFAULT '0',
  warranty_end int(11) unsigned NOT NULL DEFAULT '0',
  ...
  KEY warranty_code (warranty_code),
  KEY serial_number (serial_number),
  KEY customer_phone (customer_phone)
) ENGINE=MyISAM";

// Tạo bảng nhà cung cấp (suppliers)
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_suppliers (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(250) NOT NULL,
...
// Thêm trường supplier_id vào bảng warehouse_logs
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_warehouse_logs ADD supplier_id int(11) unsigned NOT NULL DEFAULT '0'";
// Thêm trường supplier_id vào bảng warehouse_logs_group
$sql_create_module[] = "ALTER TABLE " . $db_config['prefix'] . "_" . $module_data . "_warehouse_logs_group ADD supplier_id int(11) unsigned NOT NULL DEFAULT '0'";

$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'deepseek_api_key', 'sk-655f9391386c4d5f91d2a365dab95ee4')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'deepseek_url', 'https://api.deepseek.com/v1/chat/completions')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'deepseek_model', 'deepseek-chat')";
// Tạo bảng lưu trữ giá theo thuộc tính sản phẩm
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_products_price (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL COMMENT 'ID sản phẩm',
  `price` double NOT NULL DEFAULT '0' COMMENT 'Giá bán',
  `money_unit` char(3) NOT NULL DEFAULT 'VND' COMMENT 'Đơn vị tiền tệ',
  `price_time` int(11) NOT NULL DEFAULT '0' COMMENT 'Thời gian cập nhật giá',
  `warehouse_id` int(11) NOT NULL DEFAULT '0' COMMENT 'ID kho hàng',
  `warehouse_logs_id` int(11) NOT NULL DEFAULT '0' COMMENT 'ID log nhập kho',
  `warehouse_logs_group_id` int(11) NOT NULL DEFAULT '0' COMMENT 'ID log nhóm nhập kho',
  `note` text DEFAULT NULL COMMENT 'Ghi chú',
  `userid` int(11) NOT NULL DEFAULT '0' COMMENT 'Người cập nhật',
  ...
  KEY `warehouse_logs_id` (`warehouse_logs_id`),
  KEY `warehouse_logs_group_id` (`warehouse_logs_group_id`)
) ENGINE=MyISAM COMMENT='Bảng lưu lịch sử giá sản phẩm'";

// Xóa bảng price_config
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_price_config (
...
// Thêm dữ liệu mẫu cho bảng cấu hình giá
$sql_create_module[] = "INSERT IGNORE INTO " . $db_config['prefix'] . "_" . $module_data . "_price_config (`price_type`, `title`, `description`, `weight`, `status`) VALUES
('retail', 'Giá bán lẻ', 'Giá mặc định khi bán lẻ cho khách hàng', 1, 1),
('wholesale', 'Giá bán sỉ', 'Giá bán sỉ cho đại lý, cửa hàng', 2, 1),
('promotion', 'Giá khuyến mãi', 'Giá khuyến mãi khi có chương trình giảm giá', 3, 1),
('import', 'Giá nhập', 'Giá nhập sản phẩm từ nhà cung cấp', 4, 1)";

$sql_create_module[] = "DROP TRIGGER IF EXISTS update_product_price";
$sql_create_module[] = "
CREATE TRIGGER update_product_price AFTER INSERT ON " . $db_config['prefix'] . "_" . $module_data . "_products_price
FOR EACH ROW
BEGIN
    IF NEW.warehouse_logs_group_id = 0 THEN
        UPDATE " . $db_config['prefix'] . "_" . $module_data . "_rows SET product_price = NEW.price WHERE id = NEW.product_id;
    END IF;
END
";

// Tạo bảng lưu lịch sử thay đổi giá sản phẩm
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_price_history (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `price_id` int(11) NOT NULL COMMENT 'ID bảng products_price',
  `old_price` double NOT NULL DEFAULT '0' COMMENT 'Giá cũ',
  `new_price` double NOT NULL DEFAULT '0' COMMENT 'Giá mới',
  `userid` int(11) NOT NULL DEFAULT '0' COMMENT 'Người cập nhật',
  `change_time` int(11) NOT NULL DEFAULT '0' COMMENT 'Thời gian thay đổi',
  `reason` varchar(250) DEFAULT NULL COMMENT 'Lý do thay đổi',
  PRIMARY KEY (`id`),
  KEY `price_id` (`price_id`)
) ENGINE=MyISAM COMMENT='Bảng lưu lịch sử thay đổi giá sản phẩm'";
