...
if (!function_exists('nv_pro_catalogs')) {
     ...
     * @return
     */
    function nv_block_config_product_catalogs_blocks($module, $data_block)
    {
        global $db, $language_array, $db_config, $nv_Lang;
     ...
     * @return
     */
    function nv_block_config_product_catalogs_blocks_submit($module)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
