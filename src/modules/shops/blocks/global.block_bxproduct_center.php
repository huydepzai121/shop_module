...
if (!nv_function_exists('nv_global_bxproduct_center')) {
     ...
     * @return
     */
    function nv_block_config_bxproduct_center_blocks($module, $data_block)
    {
        global $db_config, $site_mods, $nv_Cache, $nv_Lang;
        ...
        $html .= "<div class=\"form-group\">";
        $html .= "  <label class=\"control-label col-sm-6\">" . $nv_Lang->getModule('auto') . "</label>";
        $auto = ($data_block['auto'] == 1) ? 'checked="checked"' : '';
        $html .= "  <div class=\"col-sm-18\"><input type=\"checkbox\" name=\"config_auto\" value=\"1\" " . $auto . " \></div>";
        $html .= "</div>";

        $html .= "<div class=\"form-group\">";
        $html .= "<label class=\"control-label col-sm-6\">" . $nv_Lang->getModule('mode') . "</label>";
        $html .= "<td>";
        ...
        $html .= "<div class=\"form-group\">";
        $html .= "	<label class=\"control-label col-sm-6\">" . $nv_Lang->getModule('speed') . "</label>";
     ...
     * @return
     */
    function nv_block_config_bxproduct_center_blocks_submit($module)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    {
        global $site_mods, $global_config, $module_config, $module_name, $global_array_shops_cat, $db_config, $my_head, $db, $pro_config, $money_config, $blockID, $nv_Cache, $nv_Lang;
