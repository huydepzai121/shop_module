...
if (!function_exists('nv_filter_product_cat')) {
     ...
     * @return
     */
    function nv_block_config_filter_product_cat($module, $data_block)
    {
        global $nv_Cache, $db_config, $site_mods, $nv_Lang;

        $html = '';
        $html .= "<div class=\"form-group\">";
        $html .= "	<label class=\"control-label col-sm-6\">" . $nv_Lang->getModule('content') . "</label>";
     ...
     * @return
     */
    function nv_block_config_filter_product_cat_submit($module)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    {
        global $module_name, $module_info, $site_mods, $module_file, $module_upload, $db, $module_data, $db_config, $id, $catid, $pro_config, $global_config, $global_array_group, $global_array_shops_cat, $nv_Request, $array_id_group, $catid, $op, $nv_Lang;
