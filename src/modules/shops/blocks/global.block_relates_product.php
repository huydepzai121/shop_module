...
if (!nv_function_exists('nv_relates_product')) {
     ...
     *
     */
    function nv_block_config_relates_blocks($module, $data_block)
    {
        ...
        $html .= "<div class=\"form-group\">";
        $html .= "	<label class=\"control-label col-sm-6\">" . $nv_Lang->getModule('cut_num') . "</label>";
     ...
     *
     */
    function nv_block_config_relates_blocks_submit($module)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    {
        global $nv_Cache, $nv_Cache, $site_mods, $global_config, $module_config, $module_config, $module_name, $module_info, $global_array_shops_cat, $db_config, $my_head, $db, $pro_config, $money_config, $array_wishlist_id, $nv_Lang;
